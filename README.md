...
The main purpose of this simple script is to monitor masternode status and peer connections in real-time. It will display all current outbound connections of your masternode with great amount of statistis which can be used for troubleshooting of sync issues.
...
===========================================================================
Outbound connections to other Bitnexus nodes [Bitnexus datadir: /root/.bitcoinnodecore]
===========================================================================
